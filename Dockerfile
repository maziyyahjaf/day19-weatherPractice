...
ENTRYPOINT ["java",  "-jar", "target/day19WeatherPractice-0.0.1-SNAPSHOT.jar"]
...
COPY --from=builder /code_folder/target/day19WeatherPractice-0.0.1-SNAPSHOT.jar day19weather.jar
...
ENTRYPOINT ["java", "-jar",  "day19weather.jar"]
